# jianzhen-photo-caption — Jianzhen-style Photo Captions

Generate **captions in the literary style of Jianzhen (简媜, Taiwanese essayist)** for your photos. One run produces two parts:

1. **25 most relevant excerpts from Jianzhen's works** — each with 《book》(essay) source attribution and a one-line reason connecting it to the photo (supports multi-sentence fragments and mood-matched passages)
2. **15 original captions**: 5 prose pieces, 5 modern poems, 5 short lines — written in Jianzhen's sentence rhythm, image logic, and diction, but fully original (no verbatim reuse of her sentences)

Great for photography social media, Xiaohongshu / Moments posts, video cover captions, and aesthetic image copy.

## Features

- **1,521 curated excerpts**: built-in public quote / famous-line corpus from Jianzhen, grouped across 90 books and essays — including *女儿红 (The Pink Bride)*, *水问 (Asking the Water)*, *红婴仔 (The Red Infant)*, *我为你洒下月光 (I Shed Moonlight for You)*, *梦游书 (The Sleepwalking Book)*, *空灵 (The Ethereal)*, and more
...
> "Write a caption in the style of Jianzhen for this photo."

Or name the skill explicitly:

> "Use the jianzhen-photo-caption skill to caption this photo."

The AI will: parse the photo's imagery → search the corpus → pick 25 excerpts (with sources + reasons) → generate 15 original captions in Jianzhen's style → ask if you'd like another round.
...
├── references/
│   ├── corpus/                 # 1,521 Jianzhen excerpts (85 md files + book index)
...
All corpus entries come from **publicly available book excerpts, famous quotes, and single-essay selections** of Jianzhen, each retaining its 《book》(essay) source attribution. No full works are transcribed; all captions are original writing. Contact the repository maintainer if any copyright concern arises.
